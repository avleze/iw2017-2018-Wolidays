...
insert into usuario (id, apellidos, correo, cuenta_bancaria, nombre, password, username) values (2001, 'Gestor', 'gestor@gestor.com', '30956654381546347501', 'Admin', '$2a$11$Pvoym9dIepZpyvdxcMf8o.034uGYVIFrpplevbS7hWslpaZPIhFmW', 'gestor');
